...
const Exhibitions: React.FC<ExhibitionProps> = ({ title, date, description, image }) => {
  ...
  const exhibitions = [
    {
      ...
      description: 'Escuela y Clínica de rehabilitación y Desarrollo humano.',
      image: 'logotipo.png',
      category: 'Upcoming'
    },
    {
    ...
    },
    {
      ...
      description: 'Escuela Profesional de Artes Marciales Mixtas.',
      image: 'mma.png',
      category: 'Past'
    }
  ];
